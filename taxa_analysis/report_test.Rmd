...
# path to fasta files
dataset_dir <- "~/Desktop/16S_data/18121" 

# metadata file path
metadata_path <- "~/Desktop/16S_data/18121/metadata.csv"

# output dirctory
output_dir <- "~/Desktop/Oil_pipeline_analysis"

# input forward and reverse sequences to consider ('\n' delimited)
input_fasta_list_foward <- "~/Desktop/16S_data/18121/18121_fasta_list_F.txt"
input_fasta_list_reverse <- "~/Desktop/16S_data/18121/18121_fasta_list_R.txt"

# 16S reference database path
reference_db <- "~/Desktop/16S_data/databases/silva_nr_v132_train_set.fa.gz"
